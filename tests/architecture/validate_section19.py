...
for route in ["/platform/capabilities","/platform/dependencies","/platform/health","/platform/drift","/platform/config/versions","/platform/changes","/platform/config/:version/activate"]:
 assert route in routes, route
assert "/delete-redis" not in routes
...
print("Section 19 static validation passed")
